  ...
  return (
    <Container>
      <div className="min-h-screen  py-12">
        ...
        <section className=" mx-auto px-6 mb-16">
          <div className="bg-white shadow-xl rounded-2xl overflow-hidden flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 p-10">
              ...
              <p className="text-gray-700 leading-relaxed">
                IJH is a comprehensive inbound and outbound tour operator based
                in Dhaka, Bangladesh. We specialize in recruitment services,
                connecting the right talent to the right job opportunities
                worldwide. Registered as a Human Resources Firm, we proudly
                serve as a preferred Recruitment Business Partner for our
                clients.
              </p>
            </div>
