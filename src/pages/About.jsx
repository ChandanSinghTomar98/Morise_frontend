  ...
  return (
    <Container>
      <div className="bg-white py-5 text-gray-800">
          ...
          <div className="w-full max-w-[1200px] mx-auto px-6 md:px-20 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-200 leading-relaxed">
                Morise is a pioneering platform under the umbrella of Humor India,
                designed to empower individuals to achieve their global career aspirations.
              </p>
            </div>
          </div>
        </section>
        ...
        >
          <div className="bg-white/80 p-10 rounded-lg shadow-md container mx-auto px-6 md:px-20">
            ...
            <ul className="mt-4 space-y-4 text-lg">
              <li>
                <strong>Quality:</strong> We are unwavering in our commitment
                to deliver high-quality, reliable services to our users.
              </li>
              <li>
        ...
        <section
          className="bg-[#275791] px-0 mx-0 bg-cover bg-center text-white"
          style={{
            backgroundImage: "url('assets/images/nation_bg.jpg')",
          }}
        >
          <div className="bg-black/50 p-16 rounded-lg shadow-md  mx-auto px-6 md:px-20">
        ...
        <section
          className="py-10 bg-[#275791] text-white relative"
          style={{
        ...
        >
          ...
          <div className="container mx-auto px-6 md:px-20 text-center relative z-10">
            <h2 className="text-2xl md:text-4xl font-bold">Join Morise Today</h2>
