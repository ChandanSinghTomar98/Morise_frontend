          ...
          <div className="relative">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 space-y-2 text-center mx-6 md:text-left">
                ...
                <p className="text-gray-700 font-semibold">{user.occupation}</p>
            ...
            <div className="mt-4 flex flex-col md:flex-row justify-between items-center gap-4">
              <button className="bg-primary text-white px-6 py-2 rounded-full hover:bg-blue-800 transition-colors">
                {user.isRegistered ? "Profile Status" : "Register Now"}
              </button>
      ...
      <div className="p-4 mt-10 ">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            providing reliable and efficient services. Our platform is tailored
            to make the process seamless and stress-free. With Morise, you're
            not just applying for a visa; you're building a career.
          </p>
        </div>
